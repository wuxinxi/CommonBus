...
public class Des {
	...
	public static void main(String[] args) {
		Des desObj = new Des();
//		String key1 = "1";
//		String data = "我是数据加密" + "szxb";
//		System.err.println(desObj.strEnc("我是数据加密", key1));
//
//		String szxb = desObj.strEnc("szxb", key1);
//		System.err.println(szxb.length() + "-" + szxb);
//
//		String str = desObj.strEnc(data, key1);
//		System.err.println(str.length());
//		System.out.println(str);
//		String dec = desObj.strDec(str, key1);
//		System.out.println(dec);

		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
		String source = "皖S008,观光4,3,科技园,西乡步行街";
		String headFiled =format.format(new Date());

		String key = "JPEf*7fU*Cal8Zag";

		String cipSource = desObj.strEnc(source, key);
		System.err.println(cipSource.length() + "-" + cipSource);

		String cipHead = desObj.strEnc(headFiled, key);
		System.err.println(cipHead.length() + "-" + cipHead);

		System.out.println(desObj.strDec(cipHead, key));

		String filed=cipHead+cipSource;
		System.out.println(filed);

		String fielHead=filed.substring(0,48);
		String desHeadString=desObj.strDec(fielHead,key);
		if (desHeadString.equals(format.format(new Date()))) {
			String data=filed.substring(48,filed.length());
			System.err.println("fileHead="+desObj.strDec(fielHead, key));

			System.err.println("data="+desObj.strDec(data, key));

			System.err.println(desObj.strDec(filed, key));
